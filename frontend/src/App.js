  ...
  return (
    <BrowserRouter>
      ...
      >
        ...
        <header >
        <Navbar style={{ backgroundColor: "rgb(27 67 119)", color: "#fff", padding: "5px", marginBottom: "0" }} variant="dark" expand="">
  <Container>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      ...
      <Nav className="me-auto  w-100  justify-content-end">
        ...
        <footer className="text-center" style={{ backgroundColor: "rgb(27 67 119)", color: "#fff", padding: "20px 20px" }}>
    ...
    <div className="row d-flex align-items-center">
      <div className="">
        ...
        <p style={{ lineHeight: "1" }}>
          All rights reserved © by MR TECHNOLOGIES 2023.
        </p> 
      </div>
    </div>
  </div>
